...
TEST_F(CodeGenerationTest, AddLongPromote) {
  ...
  void* tuple = malloc(s->getTupleMaxSize());
  *(int*)tuple = 1;
  *((int*)s->getColumnAddress(1, tuple)) = -1;
  *((long*)s->getColumnAddress(2, tuple)) = 200;
  long ret;
  f(tuple, &ret);
  delete tuple;
  delete s;
...
TEST_F(CodeGenerationTest, Multiply1) {
  ...
  void* tuple = malloc(s->getTupleMaxSize());
  *(int*)tuple = 2;
  *((float*)s->getColumnAddress(1, tuple)) = 0.5;
  *((long*)s->getColumnAddress(2, tuple)) = 3;
  float ret;
  f(tuple, &ret);
  delete tuple;
  delete s;
...
TEST_F(CodeGenerationTest, Divide) {
  ...
  void* tuple = malloc(s->getTupleMaxSize());
  *(int*)tuple = 4;
  *((int*)s->getColumnAddress(1, tuple)) = 3;
  *((float*)s->getColumnAddress(2, tuple)) = 0.5;
  float ret;
  f(tuple, &ret);
  delete tuple;
  delete s;
...
TEST_F(CodeGenerationTest, Divide2) {
  ...
  *(int*)tuple = 4;
  *((float*)s->getColumnAddress(1, tuple)) = 0.5;
  *((double*)s->getColumnAddress(2, tuple)) = -0.5;
  double ret;
  f(tuple, &ret);
  delete tuple;
  delete s;
...
TEST_F(CodeGenerationTest, Const) {
  ...
  void* tuple = malloc(s->getTupleMaxSize());
  *((double*)s->getColumnAddress(0, tuple)) = -0.5;
  double ret;
  f(tuple, &ret);
  delete tuple;
  delete s;
...
TEST_F(CodeGenerationTest, CompareLT) {
  ...
  void* tuple = malloc(s->getTupleMaxSize());
  *((long*)s->getColumnAddress(0, tuple)) = 3;
  *((long*)s->getColumnAddress(1, tuple)) = 4;
  bool ret;
  f(tuple, &ret);
  delete tuple;
  delete s;
...
TEST_F(CodeGenerationTest, AND) {
  ...
  void* tuple = malloc(s->getTupleMaxSize());
  *((bool*)s->getColumnAddress(0, tuple)) = true;
  *((bool*)s->getColumnAddress(1, tuple)) = false;
  bool ret;
  f(tuple, &ret);
  delete tuple;
  delete s;
...
TEST_F(CodeGenerationTest, CompareEQ1) {
  ...
  void* tuple = malloc(s->getTupleMaxSize());
  *((long*)s->getColumnAddress(0, tuple)) = 2011012161127060000;
  *((long*)s->getColumnAddress(1, tuple)) = 2111106231004740;
  bool ret;
  f(tuple, &ret);
  delete tuple;
  delete s;
...
TEST_F(CodeGenerationTest, CompareEQ2) {
  ...
  void* tuple = malloc(s->getTupleMaxSize());
  *((long*)s->getColumnAddress(0, tuple)) = 2011012161127060000;
  *((long*)s->getColumnAddress(1, tuple)) = 2011012161127060000;
  bool ret;
  f(tuple, &ret);
  delete tuple;
  delete s;
...
TEST_F(CodeGenerationTest, CompareEQ3) {
  ...
  *((long*)s1->getColumnAddress(0, tuple1)) = 6;
  *((long*)s1->getColumnAddress(1, tuple1)) = 4;

  void* tuple2 = malloc(s2->getTupleMaxSize());
  *((int*)s2->getColumnAddress(0, tuple2)) = 3;
  *((double*)s2->getColumnAddress(1, tuple2)) = 6.3;
...
TEST_F(CodeGenerationTest, EqualJoinCompare) {
  ...
  void* tuple1 = malloc(s1->getTupleMaxSize());
  *((long*)s1->getColumnAddress(0, tuple1)) = 3;
  *((long*)s1->getColumnAddress(1, tuple1)) = 4;

  void* tuple2 = malloc(s2->getTupleMaxSize());
  *((long*)s2->getColumnAddress(0, tuple2)) = 4;
  *((long*)s2->getColumnAddress(1, tuple2)) = 3;
...
TEST_F(CodeGenerationTest, FilterLogic) {
  ...
  for (int i = 0; i < c_tuple_count; i++) {
    *(int*)s->getColumnAddress(0, c) = 5 + i * 5;
    *(int*)s->getColumnAddress(1, c) = 10;
    c += s->getTupleMaxSize();
  }
  ...
  EXPECT_TRUE(c_cur == c_tuple_count && b_cur == 1 &&
              *(int*)s->getColumnAddress(1, b_start) == 10);
}
...
TEST_F(CodeGenerationTest, FilterLogic1) {
  ...
  char* c = (char*)c_start;
  for (int i = 0; i < c_tuple_count; i++) {
    *(int*)s->getColumnAddress(0, c) = i * 5;
    *(int*)s->getColumnAddress(1, c) = 20;
    c += s->getTupleMaxSize();
  }
...
TEST_F(CodeGenerationTest, FilterLogic4) {
  ...
  char* c = (char*)c_start;
  for (int i = 0; i < c_tuple_count; i++) {
    *(unsigned long*)s->getColumnAddress(0, c) = 2011012161127060000 + i * 5;
    *(unsigned long*)s->getColumnAddress(1, c) = 2011012161127060000 + 20;
    c += s->getTupleMaxSize();
  }
...
TEST_F(CodeGenerationTest, FilterLogicReal) {
  ...
  char* c = (char*)c_start;
  for (int i = 0; i < c_tuple_count; i++) {
    *(unsigned long*)s->getColumnAddress(0, c) = i;
    *(unsigned long*)s->getColumnAddress(3, c) = 2011012161127060000;
    c += s->getTupleMaxSize();
  }
  ...
  EXPECT_TRUE(c_cur == c_tuple_count && b_cur == 5 &&
              *(unsigned long*)s->getColumnAddress(3, b_start) ==
                  2011012161127060000);
}
...
TEST_F(CodeGenerationTest, LessCompare3) {
  ...
  void* tuple = malloc(s->getTupleMaxSize());
  ((NValue*)s->getColumnAddress(0, tuple))->createDecimalFromString("3");
  ((NValue*)s->getColumnAddress(1, tuple))->createDecimalFromString("4");
...
TEST_F(CodeGenerationTest, LessCompare4) {
  ...
  void* tuple = malloc(s->getTupleMaxSize());
  ((NValue*)s->getColumnAddress(0, tuple))->createDecimalFromString("4");
  ((NValue*)s->getColumnAddress(1, tuple))->createDecimalFromString("4");
  //	*((NValue*)s->getColumnAddess(1,tuple))=4;
  bool ret;
  f(tuple, &ret);
...
TEST_F(CodeGenerationTest, LessCompare5) {
  ...
  void* tuple = malloc(s->getTupleMaxSize());
  ((NValue*)s->getColumnAddress(0, tuple))
      ->createDecimalFromString("4000000000000000");
  ((NValue*)s->getColumnAddress(1, tuple))
...
TEST_F(CodeGenerationTest, LessCompareDate) {
  ...
  void* tuple = malloc(s->getTupleMaxSize());
  *((date*)s->getColumnAddress(0, tuple)) = from_string("2010-11-11");
  *((date*)s->getColumnAddress(1, tuple)) = from_string("2010-11-12");
  //	*((NValue*)s->getColumnAddess(1,tuple))=4;
  bool ret;
  f(tuple, &ret);
  delete tuple;
